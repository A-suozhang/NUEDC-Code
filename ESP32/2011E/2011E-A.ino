...
// * _______________ Set Up UI ____________________
UIX uix;
...
char str0[100]="Set The Data Rate (10~100KHz)";
char str1[100]="10";

UIXInputBox inptsend0(10,200,20,50,COLVSBLUE,COLCYAN,str0);   //input box
// UIXInputBox inptsend1(10,150,60,90,COLVSBLUE,COLCYAN,str1);   //input box
UIXDynamicText data_rate_text(str1,COLWHITE,10,50,180,200);

UIXButton btnsend0(20,60,100,130,COLVSBLUE,COLCYAN,"+",btnsendclick0);
UIXButton btnsend1(80,120,100,130,COLVSBLUE,COLCYAN,"-",btnsendclick1);
UIXButton btnsend2(20,120,140,170,COLVSBLUE,COLCYAN,"Set Data Rate",btnsendclick2);

int temp_data_rate = 10;
//called when btnsend is clicked
void btnsendclick0(int tag,UIXButton* obj){
    temp_data_rate += 10;
    // Serial.println(temp_data_rate);
    sprintf(str1, "%d", temp_data_rate); 
    Serial.println(str1);
    data_rate_text.invalidate();
}
...
void btnsendclick2(int tag,UIXButton* obj){
    i2s_set_sample_rates(I2S_NUM_0,(uint32_t)(3125));
}

// * _______________ Set Up I2S ____________________
void i2sconfig(){
...
short test[8] = {0x88CC,0x0000,0x00EF,0x0000};
...
void setup(){
    ...
    uixpanels[0].label="Send Data";
    //add objects to panel 0
    uixpanels[0].uixobjects+=inptsend0;
    uixpanels[0].uixobjects+=data_rate_text;
...
void loop(){
    uix.tick();
    data_rate_text.invalidate();
    // i2s_write(I2S_NUM_0,data2send,512,&i2s_byte_write0,100);
    i2s_write(I2S_NUM_1,test,8,&i2s_byte_write0,100);
    // i2s_write(I2S_NUM_1,data2send2,32,&i2s_byte_write0,100);
